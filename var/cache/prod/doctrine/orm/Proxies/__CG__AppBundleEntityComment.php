...
class Comment extends \AppBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'message', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'author', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'task', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'createdAt'];
        }
