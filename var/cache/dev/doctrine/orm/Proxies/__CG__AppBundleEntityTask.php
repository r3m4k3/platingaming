...
class Task extends \AppBundle\Entity\Task implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'assignee', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'author', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'status', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'comments', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'createdAt'];
        }
