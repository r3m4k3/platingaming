...
class Role extends \AppBundle\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Role' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Role' . "\0" . 'key', '' . "\0" . 'AppBundle\\Entity\\Role' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Role' . "\0" . 'parentId', '' . "\0" . 'AppBundle\\Entity\\Role' . "\0" . 'isActive'];
        }
