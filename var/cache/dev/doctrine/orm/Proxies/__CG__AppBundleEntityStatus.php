...
class Status extends \AppBundle\Entity\Status implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Status' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Status' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Status' . "\0" . 'isActive', '' . "\0" . 'AppBundle\\Entity\\Status' . "\0" . 'tasks'];
        }
