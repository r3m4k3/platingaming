...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.comment.manager' => 'getApp_Comment_ManagerService',
     ...
     *
     * @return \AppBundle\Service\NotificationService A AppBundle\Service\NotificationService instance
     */
    protected function getAlertService()
    {
        return $this->services['alert'] = new \AppBundle\Service\NotificationService($this->get('session'));
    }
    ...
    /*
     * Gets the 'app.comment.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\CommentManager A AppBundle\Service\CommentManager instance
     */
    protected function getApp_Comment_ManagerService()
    {
        return $this->services['app.comment.manager'] = new \AppBundle\Service\CommentManager($this, $this->get('security.token_storage'), $this->get('router'), $this->get('form.factory'));
    }
    ...
    {
        return $this->services['app.twig_extension'] = new \AppBundle\Twig\TwigExtension($this->get('security.token_storage'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8b+aLJrhT6', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZEShsT7Q-w', '', '+BvSwI9T-NhO1YK+TQFjHA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L544tpBYLX', '', '+BvSwI9T-NhO1YK+TQFjHA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'platingaming', 'user' => 'platingaming', 'password' => 'test', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_690a2a1598c04254200e9a1956d019e123a1615d76cbdf83508f0263fd240bf2');
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/account');

        $i = new \Symfony\Component\Security\Http\AccessMap();
        $i->add($h, array(0 => 'ROLE_MANAGER', 1 => 'ROLE_DEVELOPER'), NULL);

        $j = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $j, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($j, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'security_logout'));
        ...
        $l->setOptions(array('login_path' => 'security_login_form', 'always_use_default_target_path' => true, 'default_target_path' => '/account/task/list', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $m->setOptions(array('login_path' => 'security_login_form', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $n = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $j, 'security_login_form', false);

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.database_users')), 'secured_area', $a, $c, $d), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'secured_area', $l, $m, array('check_path' => 'security_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $g, 'secured_area', $n, $a), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '579286708cf650.98748067', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $i, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $j, 'secured_area', $n, NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dt112UYWdt', '', '+BvSwI9T-NhO1YK+TQFjHA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.chain_provider'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $this->get('security.user.provider.concrete.database_users')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.database_users'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle\\Entity\\User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3306,
            'database_name' => 'platingaming',
            'database_user' => 'platingaming',
            ...
            'validator.mapping.cache.prefix' => 'validator_2b5464a59306343f8b31445d6ec1f0b19054a3515d1e7470b97d89fef74bd535',
